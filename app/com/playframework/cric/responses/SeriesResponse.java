...
public class SeriesResponse {
    ...
    public SeriesResponse(Series series, CountryResponse country, TourResponse tour, SeriesTypeResponse seriesType, GameTypeResponse gameType, List<TeamResponse> teams) {
